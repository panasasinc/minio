...
func (l *s3EncObjects) CopyObjectPart(ctx context.Context, _, _ /*srcBucket, srcObject*/, destBucket, destObject, uploadID string,
	partID int, _, _ /*startOffset, length*/ int64, srcInfo minio.ObjectInfo, _ /*srcOpts*/, dstOpts minio.ObjectOptions,
...
func (l *s3EncObjects) DeleteBucket(ctx context.Context, bucket string, _ minio.DeleteBucketOptions) error {
	var prefix, continuationToken, delimiter, startAfter string
	expParts := make(map[string]string)
